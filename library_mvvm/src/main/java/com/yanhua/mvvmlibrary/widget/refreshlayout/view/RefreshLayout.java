package com.yanhua.mvvmlibrary.widget.refreshlayout.view;
...
import com.yanhua.mvvmlibrary.widget.refreshlayout.Footer.BallPulseView;
import com.yanhua.mvvmlibrary.widget.refreshlayout.IBottomView;
import com.yanhua.mvvmlibrary.widget.refreshlayout.IHeaderView;
import com.yanhua.mvvmlibrary.widget.refreshlayout.OnAnimEndListener;
import com.yanhua.mvvmlibrary.widget.refreshlayout.OnGestureListener;
import com.yanhua.mvvmlibrary.widget.refreshlayout.PullListener;
import com.yanhua.mvvmlibrary.widget.refreshlayout.RefreshListenerAdapter;
import com.yanhua.mvvmlibrary.widget.refreshlayout.header.GoogleDotView;
import com.yanhua.mvvmlibrary.widget.refreshlayout.processor.AnimProcessor;
import com.yanhua.mvvmlibrary.widget.refreshlayout.processor.IDecorator;
import com.yanhua.mvvmlibrary.widget.refreshlayout.processor.OverScrollDecorator;
import com.yanhua.mvvmlibrary.widget.refreshlayout.processor.RefreshProcessor;
import com.yanhua.mvvmlibrary.widget.refreshlayout.utils.DensityUtil;
...
/**
 * 备注（该刷新控件仿tkrefreshlayout源码实现）
 * Created by king on 2019/1/7.
 */
public class RefreshLayout extends RelativeLayout implements PullListener, NestedScrollingChild {
    ...
    public RefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            mMaxHeadHeight = a.getDimensionPixelSize(R.styleable.RefreshLayout_tr_max_head_height, (int) DensityUtil.dp2px(context, 120));
            mHeadHeight = a.getDimensionPixelSize(R.styleable.RefreshLayout_tr_head_height, (int) DensityUtil.dp2px(context, 80));
            mMaxBottomHeight = a.getDimensionPixelSize(R.styleable.RefreshLayout_tr_max_bottom_height, (int) DensityUtil.dp2px(context, 120));
            mBottomHeight = a.getDimensionPixelSize(R.styleable.RefreshLayout_tr_bottom_height, (int) DensityUtil.dp2px(context, 60));
            ...
            isPureScrollModeOn = a.getBoolean(R.styleable.RefreshLayout_tr_pureScrollMode_on, false);
            isOverScrollTopShow = a.getBoolean(R.styleable.RefreshLayout_tr_overscroll_top_show, true);
            isOverScrollBottomShow = a.getBoolean(R.styleable.RefreshLayout_tr_overscroll_bottom_show, true);
            enableOverScroll = a.getBoolean(R.styleable.RefreshLayout_tr_enable_overscroll, true);
            floatRefresh = a.getBoolean(R.styleable.RefreshLayout_tr_floatRefresh, false);
            autoLoadMore = a.getBoolean(R.styleable.RefreshLayout_tr_autoLoadMore, false);
            enableKeepIView = a.getBoolean(R.styleable.RefreshLayout_tr_enable_keepIView, true);
            showRefreshingWhenOverScroll = a.getBoolean(R.styleable.RefreshLayout_tr_showRefreshingWhenOverScroll, true);
            showLoadingWhenOverScroll = a.getBoolean(R.styleable.RefreshLayout_tr_showLoadingWhenOverScroll, true);
        } finally {
            a.recycle();
        }
