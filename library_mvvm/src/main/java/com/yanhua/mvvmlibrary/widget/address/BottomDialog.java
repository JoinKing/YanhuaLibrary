package com.yanhua.mvvmlibrary.widget.address;
...
import com.yanhua.mvvmlibrary.widget.address.utils.Dev;
import com.yanhua.mvvmlibrary.widget.address.widget.AddressSelector;
import com.yanhua.mvvmlibrary.widget.address.widget.OnAddressSelectedListener;
...
public class BottomDialog extends Dialog {
    ...
    private void init(Context context) {
        ...
        params.height = Dev.dp2px(context, 440);
