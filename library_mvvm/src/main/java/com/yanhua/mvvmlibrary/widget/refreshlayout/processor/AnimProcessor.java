...
import com.yanhua.mvvmlibrary.widget.refreshlayout.utils.LogUtil;
import com.yanhua.mvvmlibrary.widget.refreshlayout.utils.ScrollingUtil;
...
public class AnimProcessor implements IAnimRefresh, IAnimOverScroll {
    ...
    private RefreshLayout.CoContext cp;
    private static final float animFraction = 1f;
    //动画的变化率
    private DecelerateInterpolator decelerateInterpolator;

    public AnimProcessor(RefreshLayout.CoContext coProcessor) {
        this.cp = coProcessor;
