...
/**
 * A {@link PagerAdapter} that binds items to layouts using the given or  If you give it an {@link ObservableList} it will also updated itself based on
...
public class BindingViewPagerAdapter<T> extends PagerAdapter implements BindingCollectionAdapter<T> {
     ...
     */
    public void setPageTitles(@Nullable BindingViewPagerAdapter.PageTitles<T> pageTitles) {
