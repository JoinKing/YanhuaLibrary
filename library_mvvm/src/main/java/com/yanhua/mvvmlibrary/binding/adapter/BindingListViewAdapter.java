...
public class BindingListViewAdapter<T> extends BaseAdapter implements BindingCollectionAdapter<T> {
    ...
    private BindingListViewAdapter.ItemIds<? super T> itemIds;
    private BindingListViewAdapter.ItemIsEnabled<? super T> itemIsEnabled;
     ...
     * true.
     */
    public void setItemIds(@Nullable BindingListViewAdapter.ItemIds<? super T> itemIds) {
     ...
     */
    public void setItemIsEnabled(@Nullable BindingListViewAdapter.ItemIsEnabled<? super T> itemIsEnabled) {
